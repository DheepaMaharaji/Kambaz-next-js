...
// Make sure the User type includes all the properties used below, including 'loginId'.
// If not, update the User type definition in reducer.ts to include:
...
export default function PeopleDetails({ uid, onClose }: { uid: string | null; onClose: () => void; }) {
  const [user, setUser] = useState<User>({
    ...
    password: "",
    email: "",
    // add any other required User properties with default values here
  });
